...
| <img width="891" height="891" alt="image" src="https://github.com/user-attachments/assets/e86db225-ed66-4693-989b-f9aed7fa5d08" /> | **이해니**<br/>[@haeni82](https://github.com/haeni82) | **Frontend**<br/>상담 요약 페이지(UI) 구현, 유저용 상담 요약 프롬프트(JSON) 설계, 상담사 WebSocket 양방향 통신 구조 설계, 상담 요약 및 후속 액션 제안 기능 기획 |
